...
var ErrDomainEmpty error = errors.New("whois: domain is empty")
var ErrWhoisServerNotFound error = errors.New("whois: no whois server found for domain")
